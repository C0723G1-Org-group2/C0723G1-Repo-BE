    ...
    <form action="/book?action=search" method="post">
        ...
        <table class="table">
            <tr >
                ...
                <th><button>Ngày Cập Nhật</button></th>
                <th><button>Truyện Mới</button></th>
            ...
            <tr>
                <td><button><a href="/book?action=create">Thêm Truyên Mới</a></button></td>
            </tr>
                                    ...
                                    <div class="card" style="width: 100%;">
                                        <div class="card-body article">
                                            ...
                                            <div class="btn-card" style="display: inline-block; position: absolute; bottom: 20px;">
                                                <a href="/book?action=delete&book_id=${book.getBookId()}" class="btn btn-danger mt-1">Xoá</a>
                                                <a href="/book?action=edit&book_id=${book.getBookId()}" class="btn btn-primary mt-1">Sửa</a>
                                            </div>
                                        </div>
                                    </div>
                                </a>
