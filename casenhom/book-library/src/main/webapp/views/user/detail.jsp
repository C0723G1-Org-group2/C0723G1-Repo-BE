    ...
    <div class="col-lg-8">
      <form action="/book?action=edit" method="post">
        <table class="table table-striped">
          <tr >
            <td rowspan="10" width="140px">Chi Tiết Truyện ${bookEdit.getBookName()}</td>
          </tr>
          <tr>
            ...
            <td>
           <c:out value="${bookEdit.getBookName()}"/>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            <td>Năm Xuất Bản:</td>
            <td>
         <c:out value="${bookEdit.getPublishYear()}"/>
            </td>
          </tr>
          <tr>
            <td>Image:</td>
            <td>
             <c:out value="${bookEdit.getImg()}"/>
            </td>
          </tr>
          <tr>
            <td>Số Lượng:</td>
            <td>
            <c:out value="${bookEdit.getBook_quantity()}"/>
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <c:forEach items="${bookTypeEdit}" var="bookType">
               ...
               <c:out value="${bookType.getBook_type_name()}"/>
                </c:if>
              </c:forEach>
            </td>
          </tr>
