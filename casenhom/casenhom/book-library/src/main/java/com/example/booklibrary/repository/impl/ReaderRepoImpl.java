...
public class ReaderRepoImpl implements IReaderRepo {
    private final IAccountRepository accountRepo = new AccountRepoImpl();
...
//    private final static String READER_INSERT = "INSERT INTO reader (reader_id, reader_name, address, citizen_id, date_of_birth, email , phone_number, image,id_account) VALUES (?,?,?,?,?,?,?,?,?);\";\n";
    ...
    private final static String CREATE_READER = "INSERT INTO reader(reader_name, address, citizen_id, date_of_birth, email, phone_number,image,id_account) VALUES (?, ?, ?, ?, ?, ?, ?,?)";
...
Connection connection = BaseRepository.getConnectDB();
        try {
            ...
            preparedStatement.setInt(8, reader.getAccount().getId());
